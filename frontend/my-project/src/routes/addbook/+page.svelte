...
<main>
    ...
    <div class="w-5/12 m-auto mt-5 p-1 justify-center">
        ...
        <button class=" w-full mt-5 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-xl" >Add Book</button>
    </div>
</main>